...
public class VideoListAdapter8 extends ArrayAdapter<YouTubeVideoItem8> {
    // LayoutInflater(レイアウトXMLからViewを生成)
    private LayoutInflater inflater;

    // コンストラクタ
    public VideoListAdapter8(Context context, int resourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            view = inflater.inflate(R.layout.video_list_row8, null);
        }
        ...
        // 対象のアイテムを取得
        YouTubeVideoItem8 item = getItem(position);
